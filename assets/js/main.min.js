...
function hasScrolled(){var t=$(this).scrollTop();Math.abs(lastScrollTop-t)<=delta||(t>lastScrollTop&&t>navbarHeight&&t>81?$(".s-categoryNav").removeClass("nav-down").addClass("nav-up"):t+$(window).height()<$(document).height()&&t>81&&($(".s-categoryNav").removeClass("nav-up").addClass("nav-down"),$(".s-categoryNav").addClass("-fixed")),lastScrollTop=t)}function triggerCheck(t){var e=$(t).siblings(".js-checkbox");e.is(":checked")?(e.prop("checked",!1),e.trigger("change"),$(t).empty()):(e.prop("checked",!0),e.trigger("change"),$(t).append('<span class="fa fa-check"></span>'))}function insertPostPageAdd(){var t=document.getElementById("postContent");if(null!=t){var e=$(".b-postContent").children().length,a='<ins class="adsbygoogle b-addImage postpageAddUnit" style="display:none; width:728px; height:90px" data-ad-client="ca-pub-2839664859161137" data-ad-slot="3313112802"></ins>',n='<ins class="adsbygoogle" style="display:inline-block;width:468px;height:60px" data-ad-client="ca-pub-2839664859161137" data-ad-slot="2355280008"></ins>',i='<ins class="adsbygoogle" style="display:inline-block;width:320px;height:100px" data-ad-client="ca-pub-2839664859161137" data-ad-slot="3986790400"></ins>',s=t.getBoundingClientRect().width;if(e>5){if(s>=728)var o='<div align="center">'+a+"</div>";else if(s>=468)var o='<div align="center">'+n+"</div>";else var o='<div align="center">'+i+"</div>";$(o).insertAfter(".b-postContent > *:nth-child(4)"),(adsbygoogle=window.adsbygoogle||[]).push({})}}}var didScroll,lastScrollTop=0,delta=5,navbarHeight=$(".s-categoryNav").outerHeight();$(window).scroll(function(t){didScroll=!0;var e=$(this).scrollTop();81>=e&&($(".s-categoryNav").removeClass("-fixed"),$(".s-categoryNav").removeClass("nav-up"))}),setInterval(function(){didScroll&&(hasScrolled(),didScroll=!1)},250),$(document).ready(function(){$("#newsletter").on("change",function(){triggerCheck($(this)),$(this).is(":checked")?$("#landingSubmit").val("Subscribe and Download"):$("#landingSubmit").val("Download")}),$(".js-checkbox").customCheckbox(),$("#disqus_thread").bind("DOMNodeInserted DOMNodeRemoved",function(){$(this).css("padding",16)}),$(".js-expand").addClass("-expand"),$(".js-categoryNav .hasSubmenu > a").click(function(t){t.preventDefault(),$(this).siblings(".submenu").show()}),$(window).scroll(function(){$(this).scrollTop()>100?$(".js-toTop").addClass("-show"):$(".js-toTop").removeClass("-show")}),$(".js-toTop").click(function(){return $("html, body").animate({scrollTop:0},600),!1}),$(".gallery").featherlightGallery({gallery:{fadeIn:300,fadeOut:300},openSpeed:300,closeSpeed:300}),jQuery(".js-content, .js-aside").theiaStickySidebar({additionalMarginTop:80}),$.featherlight.defaults.afterContent=function(){var t=this.$currentTarget.find("img").attr("alt");this.$instance.find(".caption").remove(),$('<div class="caption">').text(t).appendTo(this.$instance.find(".featherlight-content"))},$.featherlight.defaults.beforeClose=function(){$("body").removeClass("model-open"),$("body").css("padding-right",0)},$.featherlight.defaults.afterOpen=function(){$("body").addClass("model-open"),$("body").css("padding-right",15)},$.featherlightGallery.prototype.afterContent=function(){var t=this.$currentTarget.find("img").attr("alt");this.$instance.find(".caption").remove(),$('<div class="caption">').text(t).appendTo(this.$instance.find(".featherlight-content"))},insertPostPageAdd()}),$.fn.customCheckbox=function(){$(this).hide(),$(this).is(":checked")?$(this).before('<button class="c-checkbox js-checkboxTrigger" type="button" onclick="triggerCheck(this)"><span class="fa fa-check"></span></button>'):$(this).before('<button class="c-checkbox js-checkboxTrigger" type="button" onclick="triggerCheck(this)"></button>')},$.fn.customGallery=function(){var t=$(this).find(".b-galleryImg").width(),e=.6*t;$(this).find(".b-galleryImg").height(e),$(this).find(".b-galleryImg > img").height(e)},$(function(){$("#postContent a").attr("target","_blank")});
