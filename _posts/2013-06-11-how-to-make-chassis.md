...
The mounting and other stuffs, I leave it to you to let your imaginations fly. This type of chassis build is suitable for robots that are meant to be operated in indoor conditions where ground spacing should not be an issue. So don't have a robot with acrylic for a robo war or something of that sort.
...
<a href="http://embedjournal.com/subscribe/" target="_blank">Subscribe to our newsletters</a> and like us on Facebook to get instant updates on latest posts and how-to tutorials.
