...
Please read the article on how to <a title="Testing RF Transmitter and Receiver Circuit" href="http://embedjournal.com/2014/04/testing-rf-transmitter-and-receiver-circuit/" target="_blank">test your RF transmitter and Receiver circuit</a> in case there is a fault.

I strongly suggest you to read the post <a title="Circuit Debugging" Tips Tricks & Techniques" href="http://embedjournal.com/2014/03/circuit-debugging-tips-tricks-techniques/" target="_blank">Circuit Debugging - Tips Trick and Techniques</a> before attempting to make your own rc robot car. If you are still having any doubts, post your comment in that article and I will try my best to help you out.
...
You might want to check out these posts for your future projects!!
  ...
  * <a href="http://embedjournal.com/2013/06/line-follower-robot/" target="_blank">Line Follower Robot" Build it from scratch</a>

That's all for getting started to robotics (well it is not exactly robotics) There is a lot more to learn beyond this point. This should have cleared some of the basics up for beginners and a total waste of time for the advanced readers ![:)](http://s0.wp.com/wp-includes/images/smilies/icon_smile.gif?m=1129645325g) anyway, since its all done lets feel happy about it in either cases.
